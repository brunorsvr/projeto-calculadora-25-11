 ...
 *
 * @author Bruno Rodrigues da Silveira
 * @version 1.0
 */
public class Calculadora {
     ...
     *
     * @param a primeiro operando
     * @param b segundo operando que será subtraído de {@code a}
     ...
     *
     * <p>Se o segundo operando for zero, uma {@link IllegalArgumentException}
     * é lançada, pois divisão por zero não é permitida.</p>
     *
     * @param a numerador da operação
     * @param b denominador da operação
     * @return o resultado inteiro de {@code a / b}
